...
public class test_Confcase_OldModel {
    ...
    public static void main (String[] args) throws FileNotFoundException {
        ...
        OutputDoc outputDoc = processorOldSim.process("input_HM/confcase_Tseng");
        DrawPdf drawPdf = new DrawPdf(outputDoc, "result_HM/confcase_Tseng_2309");
