...
public class test_Heater_OldModel {
    ...
    public static void main (String[] args) throws FileNotFoundException {
        ...
        OutputDoc outputDoc = processorOldSim.process("input_HM/heaterTseng");
        DrawPdf drawPdf = new DrawPdf(outputDoc, "result_HM/heaterTseng");
